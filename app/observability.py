...
from app.agent import building_agent
from app.diagnostics import diagnose_run


logger = logging.getLogger("building_data_ai_agent")
...
def invoke_agent_observed(question):
